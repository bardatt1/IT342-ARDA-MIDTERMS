...
public class GoogleContactsService {
    ...
    // Constructor to initialize RestTemplate and ObjectMapper
    ...
    public String getContacts(String accessToken) {
        ...
        try {
            // Make a GET request to the Google People API to fetch contacts
    ...
    public String addContact(String accessToken, String firstName, String lastName, List<String> emails, List<String> phoneNumbers) {
        ...
        try {
            // Make a POST request to the Google People API to add a new contact
    ...
    public String updateContact(String accessToken, String resourceName, String firstName, String lastName, List<String> emails, List<String> phoneNumbers) {
        ...
        try {
            ...
            // Make a PATCH request to the Google People API to update the contact
    ...
    public String deleteContact(String accessToken, String resourceName) {
        ...
        try {
            // Make a DELETE request to the Google People API to delete the contact
